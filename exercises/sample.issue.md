---
title:            "A Sample issue - for mkissue"
assign:
  - "@me        
labels:           
...
When a file in this format is passed to `utils` it will create an issue in the repo where it's executed, based on the Front Matter and markDown content.
